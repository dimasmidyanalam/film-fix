...
public class ImageBannerWidget extends AppWidgetProvider {
    public static final String TOAST_ACTION = "com.example.catalogmovie.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.example.catalogmovie.EXTRA_ITEM";
